...
> I know y'all still traumatized by the Vue 2 -> 3 update.

This is a huge topic to talk about, so perhapse I'll write an article about it in the future, for then you can experiment with vapor mode in the [Vapor mode playground](https://vapor-repl.netlify.app/).
